...
function Project(props){
  console.log(props);
    return(
    <>
    <div className={`card p-0 col-10 col-md-6 col-sm-10 col-lg-5 g-2 text-${props.props.mode} bg-${props.props.backgroundmode}`}>
     <img src={process.env.PUBLIC_URL+`images/${props.image}`} className="card-img-top" alt={props.title}/>
